    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emai', models.EmailField(help_text='The contact email for the contributor.', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('rationg', models.IntegerField(help_text='The rating the reviewer has given.')),
